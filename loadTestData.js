...
It enables you to analyse data that were not previously possible. The volume, variety, complexity of the analytical processing involved, and the responsiveness required are now achievable with the product. Gaining smarter decision making but also provide faster time to value.
    `,
      ...
      {
        id: 4,
        seasonName: "2017 summer - Friday",
        hostName: "Ina Aite",
        startDate: new Date("2017-06-04"),
        endDate: new Date("2017-08-31"),
        description: `
A list of free online programming books, categorized by languages/topics
    ...
    .then(response => {
      ...
      db
        ...
        .insertMany([
          {
            id: 101,
            city: "Vilnius",
            venueName: "Juoda Raudona",
            gameDate: new Date("2017-06-17"),
            hostName: "Ina Aite",
            results: [
              {
                teamName: "E621",
          ...
          },
          {
            id: 104,
            city: "Vilnius",
            venueName: "Tres Baracudos",
            gameDate: new Date("2017-06-20"),
            hostName: "Ina Aite",
            results: [
              {
                teamName: "E621",
        ...
        .then(response => {
          console.info("Teams", response.insertedCount);
          db
            .collection("teams")
            .insertMany([
              {
              ...
              },
              {
                teamName: "No Name",
                city: "Vilnius",
                description: "Lievakai",
                picture: "blob"
              },
              {
                teamName: "O Maziukas",
                city: "Vilnius",
                description: "Visada laimi",
                picture: "blob"
              },
              {
                teamName: "Dronas",
                city: "Vilnius",
                description: "Tokios nera",
                picture: "blob"
              },
              {
                teamName: "Lavarel",
                city: "Vilnius",
                description: "Kazin ar tokie yra, bet turbut yra",
                picture: "blob"
              },
              {
                teamName: "1X",
                city: "Vilnius",
                description: "Labai smaikstus",
                picture: "blob"
              }
            ])
            .then(response => {
